...
Func RunEventValidate(ByRef $oEvent, ByRef $sError)
	...
	Switch $oEvent.Item("type")
		Case "plan.loaded", "session.preparing", "session.started", "session.stopping", "session.completed", "session.failed", "engine.check.started", "engine.check.passed", "engine.check.cancelled", "engine.check.failed", "emulator.launch.started", "emulator.launch.passed", "emulator.launch.cancelled", "emulator.launch.failed", "route.blocked", "route.ready", "route.diagnostic", "account.changed", "battle.started", "battle.completed", "battle.failed", "combat.decision", "combat.zoom-verified", "combat.deployment-verified", "combat.hero-ability", "combat.spell-command", "combat.spell-cast", "combat.spell-unconfirmed", "combat.spell-retained", "maintenance.collectors.started", "maintenance.home-verified", "maintenance.collectors.completed", "maintenance.collectors.none-actionable", "maintenance.daily-reward.started", "maintenance.daily-reward.claim-issued", "maintenance.daily-reward.unavailable", "maintenance.daily-reward.unconfirmed", "maintenance.loot-cart.started", "maintenance.loot-cart.open-issued", "maintenance.loot-cart.collect-issued", "maintenance.loot-cart.unavailable", "maintenance.loot-cart.unconfirmed", "maintenance.loot-cart.home-verified", "maintenance.treasury.started", "maintenance.treasury.castle-issued", "maintenance.treasury.entry-issued", "maintenance.treasury.collect-issued", "maintenance.treasury.confirm-issued", "maintenance.treasury.close-issued", "maintenance.treasury.unavailable", "maintenance.treasury.unconfirmed", "maintenance.treasury.home-verified", "maintenance.clan-request.started", "maintenance.clan-request.unavailable", "maintenance.clan-request.unconfirmed", "maintenance.clan-request.committed", "maintenance.clan-request.home-verified", "loot.updated", "quota.observed", "quota.exhausted", "pacing.rest.started", "pacing.rest.ended", "warning", "error"
		Case Else
