...
Func RunPlanCreateDefault($sMode = "home", $sStrategy = "auto", $sAttackScript = "profile-current")
	...
	$oPlan.Add("events_collect_treasury", False)
...
Func RunPlanValidate(ByRef $oPlan, ByRef $sError)
	...
	Local $aBoolean = ["stop_on_star_bonus", "army_manage_training", "army_wait_for_full", "army_train_spells", "army_train_sieges", "donate_keep_army", "donate_request_when_short", "events_clan_games", "events_collect_resources", "events_collect_daily_reward", "events_collect_loot_cart", "events_collect_treasury", "notify_on_stop", "notify_on_error"]
