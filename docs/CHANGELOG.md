...
* Added an explicit, one-pass Home-maintenance Daily Reward option: it may issue one recognized Claim input, recognizes the fixture-backed red post-claim close state, never accepts a gem-conversion dialog, reports issued/unavailable/unconfirmed outcomes separately, and keeps all other managed routes reward-closed.
...
* Fixed Upgrade Heroes.
* Added Fire and Ice Scenery support (Attack Only).
* Improved Streak Event Support.
* Fixed Array Bounds Error when $g_bSearchRestartPickupHero.
* Added Support for the new TOS and Personnal datas sharing Windows.
* Updated Wall Cost.
* Added support for new Survey Window.
* Added missing code in SmartWaitTrain function.
* Improved Hero Hall level management.
* Added Analytics Window Support.
* Increased Ini Table Size.
* Updated BS5 supported versions.
* Improved Train Drag and Click.
* Added Metal Pants Equipment Support.
* Added Troop Launcher Support.
* Remove free builder check for cleaning yards.
* Updated Training Times.
* Updated Helper Hut coords.
* Updated Blacksmith coords.
* Added Snake Bracelet Equipment Template.
* Added New Buildings Levels To Search Filter.
* Added Year of the Snake Scenery support (Attack Only).
* Updated Few GUI Stuff.
* Added New Level Buildings Templates For Detection.
* Updated Build2 Lib.
* Improved Builder Base Defaut Scenery Detection (Thanks to WarMan).
* Fixed Hero Level OCR 99->100.
* Fixed Pets Checkboxes disabled when TH17.
* Fixed Okay Purge button detection.
* Added Ended and New Season Windows support.
* Changed SCID Account Image Tolerance (98->92).
* Improved Drag To The Left Training Bar.
* Updated Maximum Number of Reserved Builder's for Hero Upgrade.
* Fixed Ok button detection if item storage full when collect clan games rewards.
* Improved Clan Games Rewards Collect.
* Updated Lightning Spell Values.
* Improved Lightning Level OCR.
* Added Military Scenery support (Attack Only).
* Improved Army Button Detection.
* Improved CC Cap OCR (8).
* Fixed Event Super Troop Variable Type.
* Added New Survey Window Support.
* Added Voucher Window Support.
* Updated Treasury Chest Function.
* Updated Supercharge Upgrade Detection.
* Improved auto upgrade (heroes).
* Updated Train Function.
* Updated Hero Status Detection.
* Added Noble Iron Equipment Support.
* Added 340 Slots Support (TH17).
* Improved Army Cap OCR.
* Improved Few Train Troops Detection.
* Added Sneezy Support.
* Updated Walls, Champion and Pets Cost.
* Added Furnace Full Support.
* Updated Donate System.
* Updated Army System.
* Added Pause Options.
* Fixed consecutive attacks function.
* Fixed Supertroops Boost.
* Added Action Figure Equipment Support.
* Improved Drag Train.
* Added ClashMania Scenery Support (Attack Only).
* Updated Switch Tab.
* Improved Army Tab management.
* Improved CheckObstacles.
* Fixed Spells Train.
* Updated Legend Preparation.
* Updated Attack Algorithms.
* Fixed Missing Furnace in $listInfoDeploy
* Fixed Legend League Attack.
* Improved camps and troop count libs.
* improved hero detection in army window.
* Improved Dead Eagle Detection.
* Fixed Few Bugs and OCR Issues.
* Updated Misc Clan Games Challenges Conditions.
* Fixed CC Sieges Out of Bound Issue.
* Disabled QuickTrain Tab.
* Cleaned Tabs : Hidden Training Order and Boost Tabs.
* Merged Train Options Tab and Boost super troops settings -> Timings/Boost Tab.
* Updated BS5 versions.
* Added purple tombs template.
* Added Hero Hall Values Check.
* Updated CG Challenges Difficulties and Conditions.
* Fixed Clan Castle Detected as Full When it's not.
* Improved Request System.
* Clean up.
* Added missing code in MyBot.run.au3.
* Fixed Issue with CSV Apply.
* Updated SwitchToNextWallLevel()
* Added More Templates For Cancel and Finish Now Buttons.
* Updated BS5 versions.
* Improved UTCTimeCG().
* Improved Siege Level OCR (5 Blue).
...
** Updated or new OCR libraries (29 total changed)
** Updated image detection templates (Over 200 changes)
** Updated code in ~100 different MBR files.
* This version requires an update to CoC game version v15.547.8+ and a new supported emulator version.
** Nox use requires a patched version v7.0.5.9017-9.0901231011 or newer.
** Added support for Memu v9.01 to v9.06
** Removed support for BlueStacks. 
** See MBR forum for details: https://mybot.run/forums/index.php?/topic/64696-which-emulator-is-best-for-me-aka-current-emulator-advice-from-developers/
* Added Support for Bomber Ability Activation with several Bombers.

* v8.1.1 **
* Added Special Enemy Resources Offset Support.
* Added Wall Count update for Auto-upgrade.
* Added Stats from Auto-upgrade in Stats Misc.
* Added COC v15.352.22 support (Requires game app update to v15.352.22+)
* Removed Code for iTools emulator (support discontinued)
* Update ADB selection options in GUI (remove DUMMY.EXE option)
* Added support for AutoIt v3.3.16 by fixing log color conflicts (orange, grey, green)
* Incredible amount of work by @moebius and @MonkeyHunter to fix many update induced bugs:
** Adjusted StartSlot and SlotOffset values for BB Attack Bar detection.
** Adjusted IsSettingPage color for check.
** Improved all super troops detection.
** Updated TH Weapon level OCR.
** Increased Tolerance for Stone Pixel ccenery detection.
** Improved red costs OCR.
** Improved Sneaky Goblin Detection.
** Improved Bonus OCR.
** Improved Wizard detection in army overview.
** Improved troops detection in army overview.
** Improved Camp Size detection (Double Train).
** Improved Super Wizard detection in queue and army overview.
** Improved OCR for buildings/heroes costs.
** Fixed BB Army Check.
** Fixed Chess Scenery Detection.
** Added Magical theater Scenery (Attack Only).
** Improved pixel color detection for some buttons.
** Fixed Dragon Rider detection in queue list.
** Fix and clean up Nox/BS emulator version detection code
** Correct emulator check version number for BS
** Improved White Upgrade Cost Detection.
** Improved OCR for red costs in laboratory.
** Improved OCR for upgrades costs (Red).
** Updated Train and Laboratory templates.
** Clean up Android Nox code, remove unused code for no longer supported Nox versions.
* Return of clangames.ini file; requires updating your GC settings.
* Lots of improvements to Clan Games
* Addressed issues with Giant vs SuperGiant detection in training queue.
* Updated Clan Games Rewards Collect.

* v8.1 **
* Added Clan Capital Trophies and League.
* CC trophies in multistats (page 3).
* Added Reload Game Click when Amazon OOS message.
* AutoUpgrade and Lab Cost/Duration OCR improvement.
* Fixed Forge with BB Loot.
* Added Safe Loot Level in GUI for ForgeCraft.
* Rewritten checkObstacles.au3 with new Error Windows.
* Fixed BB Builders Count in multistats tab.
* Fixed Some Super Troops Boost.
* Added Monolith to Weak Base Filter, CSV SIDEB & MAKE (Target).
* Changed Tolerance of Request Button when available.
* Added Login Fail Error Window.
* Cleaned CheckObstacles Code and Images.
* Improved Super Troops Boost.
* Improved Monolith Level 1 Detection.
* Can Now Target Both ScatterShots [CSV].
* Handle for green button in Daily Rewards Window.
* Improved Some Detections (Sieges Switch Window & Spell requests).
* Fixed Wall Upgrade Error in Auto Upgrade.
* Adjusted Some Coordinates For Clan Capital Upgrades.
* Fixed Close Start Craft Window When Not Enough Resource.
* Added BS5 Pie64 Support (Based on Work of Xbebenk).
* Added Nox Pie64 Support.
* Revert To Google Distribution.
* Fixed Lab Check Upgrade in Progress.
* Improved OCR in Clan Capital.
* Fixed OCR Costs Values (Update BB2.0).
* Added Missing Images For Scattershots Level 1.
* Improved "Log in with Supercell ID" Management.
* Fixed Builder Base ZoomOut
* Added Otto Outpost ZoomOut
* Added ElectroFire Wizard To Star Laboratory.
* Added Reboot Emulator if "COC isn't Responding" Window is detected.
* Fixed BS 'hang' during attack search.
* Added Elixir Cart Collect.
* Added New BB Leagues and Logos in GUI.
* Added Smart use of resources for Forge.
* Trying to fix COC resets to tutorial base
* Trying to prevent infinite BB / Main base switching loop
* Added Get out of BB Reinforcement base
* Fixed OCR White Values for forge.
* Fixed ScreenCoordinates for Daily Challenge Window.
* Improved some red costs values.
* June 2023 Update Fixes
** Added New Pet Levels.
** New hero levels and costs.
** Fixed Heroes and Pets upgrade time.
** Super Hog Rider support.
** Apprentice Warden support.
** Fixed OCR White/Red Labs Costs Values
* Added BB 2.0 Attack support.
* Updated BB 2.0 AutoUpgrade.
* Fixed Forge Gold Collect.
* Added Minor Update Detection.
* Added Eagle level 6 and ScatterShots level 4 image match templates.
* Added Level 5 support for Wall Wrecker and Stone Slammer.
* Added Auto forge slot Support.
* Improved SuperTroops Boost start.
* Fixed Check Discount Perks.
* Added Some New BB Challenges for Clan Games.
* Removed Personnal Break and grace time.
* Fixed Switch Between Bases old issue.
* Improved BB Blue Village detection.
* Improved obstacles detection.
* Added basic BB attack support to Clan Games.
* Added Support for Second Classic BB Scenery.
* Enabled Stop before completing your limit and only Purge.
* Added BOB Control upgrades.
* Added BB Wall Both Upgrade Button support.
* Added Dark Ages, Painter, Goblin Caves, Jolly Sceneries support (Attack Only).
* Added Future, Books of Clash, Spooky Sceneries support (Attack Only).
* Added BB Crystal Caves Scenery support (Attack Only).
* Changed Replace ADB : default With dummy.exe to default Don't replace adb.exe.
...
* fixed Builder Base wall upgrade with builder elixir.
* Fix for ClanCapital array bounds crash.
* Fix Attack window detection.
* Fixed AutoUpgrade Ignore array error.
* Fix lab drag problem.
* Preparation for October 2022 update: 
- CSV preparation for TH15.
- Added Lab lvl 13 image names + tolerances.
- Added Heroes costs + levels.
- TH15 images, Wall lvl 16 support.
- Add Recall Spell To Scripted Attacks Gui. 
- $eTroopCount, $eSpellCount dimensions ajust in few files. 
- Improve CC Builder Border Window Detection.
- Fixed drop order icons. 
- Fixed drop order in Standard attack. 
- Fixed Custom Troop Icons in Donation Tab. 
- Updated troop and custom troop deployment in smartfarm.
- Updated troop and custom troop deployment in standard attack.
- PetHouse : New Pets + Switch Account (Pet house time) support.
- Laboratory troops, spells and sieges detection improvement.
- Fixed Typo Electro Owl.
- Corrected OCR 8 Red & White in StarLab.
- Fixed troop donation.
- Fixed $aCheckFrequency Array Dimension error [TH15].
- Improve Auto Upgrade and Buildings upgrades.
* Added Electro Titan - ETitan
* Added Battle Drill - BattleD
* Added Recall Spell - ReSpell
* Added Clash Fest scenery - no home support.
* Added Magic scenery - no home support.
* Added TH Weapon Support (TH Weapon Button).
* Updated SCID.
* Donations stats rewrite & updated with new troop/spell/sieges.
* Disabling Spells & Sieges in Gui (training) depending TH level.
* Donate when attack scheduling is idle.
* Added Pet House Upgrade Time to Multi-Stats Page 2.
* Builders Base & Clan Capital Resources now managed when Switch Account.

* v7.9.10 **
* Added Autumn Scenery   ** Must rebuild broken Boat
* Updated Summer Scenery ** Must rebuild Broken Boat

* v7.9.9 **
- Summer update 2022 included ( training costs removal, wall lvl elixer upgrade )
- Some zoom-out recoding, please test any scenery and give feedback
- Trader "sold-out" check
- Updated ClanGames incl Builderbase
- Auto Clan Games collect rewards activated.
  You will need to enable it.  
  The priority is; books-1, gems-2, runes-3, shovel-4, Research\Builder Pots-5, 50gems-6, wall rings-7, all other Pots-8, 10gems-9
- remove troop/spells/siege cost in UI
- disable update_shared_pref in UI
- add multiple zoomout scripts
- fix flame flinger donation
- fix attackbar 
   - siege level OCR
   - ligthning spell level OCR
   - when first troop is Super Troop
   - when 2 of the same spell is visible
- enable BattleMachine upgrade - ( still need low level BM images )  
- fix deploy BM lvl 1-4
- add networkconnection check to AttackBB
- add sleep to ZoomOut loop
- fix siegemachine OCR
- ClanGames rewards auto collect
- BB drop order + BM deployment
- Fix troop deploy when BM upgrading
- Fix FlameF attackbar template
- Improve ClanCapital upgrade
