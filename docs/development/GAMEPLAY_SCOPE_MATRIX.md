...
| Collectors and mines | `COCBot/functions/Run/OpenHomeCollectors.au3` | Exact-current packaged-binary route is runtime-evidenced: three accepted clicks increased Gold, Elixir, and Dark Elixir; Home was re-proved and gems remained unchanged. | Keep the current fixture/evidence lineage valid across future collector, capture, or input changes |
