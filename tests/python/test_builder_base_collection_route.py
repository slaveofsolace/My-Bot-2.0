...
class BuilderBaseCollectionRouteTest(unittest.TestCase):
    ...
    def test_builder_route_is_bound_to_start_contract_and_run_events(self):
        ...
        self.assertIn("OpenHomeInactivityReloadIssue(False)", gui)
        self.assertIn("OpenHomeStartupRecoveryWait(False)", gui)
        self.assertLess(gui.index("OpenHomeInactivityReloadIssue(False)"), gui.index("OpenBuilderBaseCollectorsProveBuilder()"))
