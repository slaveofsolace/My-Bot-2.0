...
class SmartAttackStrategyTests(unittest.TestCase):
    ...
    def test_planner_exposes_the_strategy_honestly(self):
        ...
        self.assertIn("managed-engine initialization", standard["description"].lower())
        ...
        self.assertIn("2026-08-14 bea12973 localruntime checkpoint", smart["description"].lower())
        self.assertIn("managed-engine initialization", smart["description"].lower())
        self.assertIn("post-checkpoint", smart["description"].lower())
    ...
    def test_battle_and_emulator_evidence_are_not_conflated(self):
        ...
        self.assertIn("2026-08-14 bea12973 localruntime checkpoint", regular["description"].lower())
        self.assertIn("managed-engine initialization", regular["description"].lower())
        self.assertIn("post-checkpoint", regular["description"].lower())
        self.assertIn("unbuilt", regular["description"].lower())
        ...
        self.assertIn("connected-but-idle", bluestacks["description"].lower())
        self.assertIn("2026-08-14 bea12973 localruntime checkpoint", bluestacks["description"].lower())
        self.assertIn("managed-engine check", bluestacks["description"].lower())
        self.assertIn("not launched", bluestacks["description"].lower())
        self.assertIn("post-checkpoint", bluestacks["description"].lower())
        self.assertIn("unbuilt", bluestacks["description"].lower())
        self.assertIn("managed start", bluestacks["description"].lower())
        self.assertIn("live human review", bluestacks["disabled_reason"].lower())
