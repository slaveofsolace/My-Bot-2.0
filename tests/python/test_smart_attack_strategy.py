...
class SmartAttackStrategyTests(unittest.TestCase):
    ...
    def test_planner_exposes_the_strategy_honestly(self):
        ...
        self.assertIn("2026-08-13 e05c415a localruntime checkpoint", standard["description"].lower())
        self.assertIn("idle-launch", standard["description"].lower())
        ...
        self.assertIn("2026-08-13 e05c415a localruntime checkpoint", smart["description"].lower())
        self.assertIn("idle-launch", smart["description"].lower())
    ...
    def test_battle_and_emulator_evidence_are_not_conflated(self):
        ...
        self.assertIn("2026-08-13 e05c415a localruntime checkpoint", regular["description"].lower())
        self.assertIn("idle-launch", regular["description"].lower())
        ...
        self.assertIn("2026-08-13 e05c415a localruntime checkpoint", bluestacks["description"].lower())
