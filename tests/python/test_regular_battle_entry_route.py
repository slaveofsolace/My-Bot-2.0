...
class RegularBattleEntryRouteTests(unittest.TestCase):
    ...
    def test_no_premium_points_are_exact_and_frame_revalidated(self):
        ...
        self.assertIn("$iX = 65 And $iY = 608", policy)
        ...
        self.assertIn("$OPEN_REGULAR_BATTLE_ENTRY_OPEN_X = 65", recognizers)
        self.assertIn("$OPEN_REGULAR_BATTLE_ENTRY_OPEN_Y = 608", recognizers)
