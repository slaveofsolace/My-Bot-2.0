...
; Third input is total enemy-base destruction. A normal strategy trigger requires
; both the role's elapsed and destruction milestones; a later deadline prevents
; wasting an otherwise usable ability when progress telemetry stalls.
AssertEqual(SmartAttackPolicyHeroAbilityReason($SMART_ATTACK_HERO_WARDEN, 9999, 12), "", "destruction alone cannot fire Warden")
AssertEqual(SmartAttackPolicyHeroAbilityReason($SMART_ATTACK_HERO_WARDEN, 10000, 11), "", "time alone cannot fire Warden")
AssertEqual(SmartAttackPolicyHeroAbilityReason($SMART_ATTACK_HERO_WARDEN, 10000, 12), "phase", "Warden fires at the support phase quorum")
AssertEqual(SmartAttackPolicyHeroAbilityReason($SMART_ATTACK_HERO_WARDEN, 20000, -1), "deadline", "Warden retains a late fallback without destruction telemetry")
AssertEqual(SmartAttackPolicyHeroAbilityReason($SMART_ATTACK_HERO_PRINCE, 17999, 25), "", "destruction alone cannot fire Prince")
AssertEqual(SmartAttackPolicyHeroAbilityReason($SMART_ATTACK_HERO_PRINCE, 18000, 24), "", "time alone cannot fire Prince")
AssertEqual(SmartAttackPolicyHeroAbilityReason($SMART_ATTACK_HERO_PRINCE, 18000, 25), "phase", "Prince fires at the breach phase quorum")
AssertEqual(SmartAttackPolicyHeroAbilityReason($SMART_ATTACK_HERO_PRINCE, 36000, 0), "deadline", "Prince retains a late fallback")
AssertEqual(SmartAttackPolicyHeroAbilityReason($SMART_ATTACK_HERO_QUEEN, 23999, 35), "", "destruction alone cannot fire Queen")
AssertEqual(SmartAttackPolicyHeroAbilityReason($SMART_ATTACK_HERO_QUEEN, 24000, 34), "", "time alone cannot fire Queen")
AssertEqual(SmartAttackPolicyHeroAbilityReason($SMART_ATTACK_HERO_QUEEN, 24000, 35), "phase", "Queen fires at the core phase quorum")
AssertEqual(SmartAttackPolicyHeroAbilityReason($SMART_ATTACK_HERO_QUEEN, 48000, -1), "deadline", "Queen retains a late fallback")
AssertEqual(SmartAttackPolicyHeroAbilityReason($SMART_ATTACK_HERO_CHAMPION, 29999, 45), "", "destruction alone cannot fire Champion")
AssertEqual(SmartAttackPolicyHeroAbilityReason($SMART_ATTACK_HERO_CHAMPION, 30000, 44), "", "time alone cannot fire Champion")
AssertEqual(SmartAttackPolicyHeroAbilityReason($SMART_ATTACK_HERO_CHAMPION, 30000, 45), "phase", "Champion fires at the sweep phase quorum")
AssertEqual(SmartAttackPolicyHeroAbilityReason($SMART_ATTACK_HERO_CHAMPION, 58000, -1), "deadline", "Champion retains a late fallback")
AssertEqual(SmartAttackPolicyHeroAbilityReason($SMART_ATTACK_HERO_KING, 33999, 50), "", "destruction alone cannot fire King")
AssertEqual(SmartAttackPolicyHeroAbilityReason($SMART_ATTACK_HERO_KING, 34000, 49), "", "time alone cannot fire King")
AssertEqual(SmartAttackPolicyHeroAbilityReason($SMART_ATTACK_HERO_KING, 34000, 50), "phase", "King fires at the tank phase quorum")
AssertEqual(SmartAttackPolicyHeroAbilityReason($SMART_ATTACK_HERO_KING, 65000, -1), "deadline", "King retains a late fallback")
