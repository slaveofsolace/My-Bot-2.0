...
; Pure contract harness stubs: this test validates Home-maintenance route selection
; and event contract dispatch only. The production entrypoints compile the real
; page-recognition and clean-room detector graph.
